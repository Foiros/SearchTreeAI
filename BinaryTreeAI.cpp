...
BinaryTreeAI::BinaryTreeAI() = default;

BinaryTreeAI::~BinaryTreeAI() = default;

void BinaryTreeAI::Insert(int data, States state) {
...
struct Node *BinaryTreeAI::Search(int data) {
...
void BinaryTreeAI::PreOrderTraversal(struct Node* _root) {
...
void BinaryTreeAI::InOrderTraversal(struct Node* _root) {
...
void BinaryTreeAI::PostOrderTraversal(struct Node* _root) {
...
struct Node *BinaryTreeAI::GetRoot() {
